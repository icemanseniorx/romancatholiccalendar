...
- Moved each iPhone setup screenshot directly beneath the instruction it illustrates.
...
- Preserved all 365 original all-day event `UID` values and advanced event revision metadata to `SEQUENCE:7`.
